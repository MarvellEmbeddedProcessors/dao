...
TEST_ENV_VARS+=" EP_REMOTE_HOST=${EP_REMOTE_HOST:-}"
TEST_ENV_VARS+=" EP_SSH_CMD='$EP_SSH_CMD' EP_DIR=$EP_DIR"
TEST_ENV_VARS+=" EP_DEVICE_SUDO=$EP_DEVICE_SUDO"
TEST_ENV_VARS+=" EP_REMOTE_SUDO=$EP_REMOTE_SUDO EP_HOST_SUDO=$EP_HOST_SUDO"
TEST_ENV_VARS+=" EP_REMOTE_HOST_SUDO=$EP_REMOTE_HOST_SUDO"
...
TEST_ENV_VARS+=" EP_REMOTE_HOST_MODULE_DIR=${EP_REMOTE_HOST_MODULE_DIR:-}"
TEST_ENV_VARS+=" MQ_TEST_FILTER=${MQ_TEST_FILTER:-}"
TEST_ENV_VARS+=" PERFTEST_FILTER=${PERFTEST_FILTER:-}"
TEST_ENV_VARS+=" RDMA_SCENARIO=${RDMA_SCENARIO:-}"
