...
enum dao_eth_trs_op_type {
	...
	/** RSA PSS SIGN */
	DAO_ETH_TRS_OP_TYPE_CRYPTO_PSS_SIGN,
	/** RSA PSS VERIFY */
	DAO_ETH_TRS_OP_TYPE_CRYPTO_PSS_VERIFY,
	/** OP type crypto end */
...
struct __rte_packed_begin dao_eth_trs_hdr {
...
struct __rte_packed_begin dao_eth_trs_pkt {
	/** Packet header */
