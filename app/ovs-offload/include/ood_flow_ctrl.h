...
struct dao_flow *ood_flow_create(uint16_t portid, struct rte_flow_attr *attr,
				 struct rte_flow_item *pattern, struct rte_flow_action *action,
				 struct rte_flow_error *err);
int ood_flow_destroy(uint16_t portid, struct dao_flow *flow, struct rte_flow_error *err);
...
int ood_flow_dump(uint16_t portid, struct dao_flow *flow, uint8_t is_stdout,
		  struct rte_flow_error *err);
int ood_flow_query(uint16_t repr_qid, struct dao_flow *flow, uint8_t reset,
		   struct rte_flow_action *action, struct rte_flow_error *err,
