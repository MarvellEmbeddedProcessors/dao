...
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **_marvell-dao_**      | ![GitHub Release](https://img.shields.io/github/v/release/MarvellEmbeddedProcessors/dao?sort=date&filter=dao*) | [![build](https://github.com/MarvellEmbeddedProcessors/dao/actions/workflows/build-cn10k-dao.yml/badge.svg)](https://github.com/MarvellEmbeddedProcessors/dao/actions/workflows/build-cn10k-dao.yml)      |
...
| **_marvell-oct-ep-target_**      | ![GitHub Release](https://img.shields.io/github/v/release/MarvellEmbeddedProcessors/dao?sort=date&filter=oct-ep*)                     | [![build-cn10k](https://github.com/MarvellEmbeddedProcessors/dao/actions/workflows/build-cn10k-pcie-ep.yml/badge.svg)](https://github.com/MarvellEmbeddedProcessors/dao/actions/workflows/build-cn10k-pcie-ep.yml)                   |
