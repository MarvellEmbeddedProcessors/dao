...
+----------------+------------------+---------------+
| Algorithm      | Key Size         | Digest Length |
+================+==================+===============+
| SHA1           | N/A              | 20 bytes      |
+----------------+------------------+---------------+
| SHA2-224       | N/A              | 28 bytes      |
+----------------+------------------+---------------+
| SHA2-256       | N/A              | 32 bytes      |
+----------------+------------------+---------------+
| SHA2-384       | N/A              | 48 bytes      |
+----------------+------------------+---------------+
| SHA2-512       | N/A              | 64 bytes      |
+----------------+------------------+---------------+
| SHA3-224       | N/A              | 28 bytes      |
+----------------+------------------+---------------+
| SHA3-256       | N/A              | 32 bytes      |
+----------------+------------------+---------------+
| SHA3-384       | N/A              | 48 bytes      |
+----------------+------------------+---------------+
| SHA3-512       | N/A              | 64 bytes      |
+----------------+------------------+---------------+
| SHA1-HMAC      | 1 - 1024 bytes   | 20 bytes      |
+----------------+------------------+---------------+
| SHA2-224-HMAC  | 1 - 1024 bytes   | 28 bytes      |
+----------------+------------------+---------------+
| SHA2-256-HMAC  | 1 - 1024 bytes   | 32 bytes      |
+----------------+------------------+---------------+
| SHA2-384-HMAC  | 1 - 1024 bytes   | 48 bytes      |
+----------------+------------------+---------------+
| SHA2-512-HMAC  | 1 - 1024 bytes   | 64 bytes      |
+----------------+------------------+---------------+
| SHA3-224-HMAC  | 1 - 1024 bytes   | 28 bytes      |
+----------------+------------------+---------------+
| SHA3-256-HMAC  | 1 - 1024 bytes   | 32 bytes      |
+----------------+------------------+---------------+
| SHA3-384-HMAC  | 1 - 1024 bytes   | 48 bytes      |
+----------------+------------------+---------------+
| SHA3-512-HMAC  | 1 - 1024 bytes   | 64 bytes      |
+----------------+------------------+---------------+
| AES-CMAC       | 16 bytes         | 1 - 16 bytes  |
+----------------+------------------+---------------+
...
|                 | 256 bits       |               |               |                 |
+-----------------+----------------+---------------+---------------+-----------------+
| AES-GMAC        | 128 bits       | 16 bytes      | 12 bytes      | 0 - 1024 bytes  |
|                 +----------------+               +               +                 +
|                 | 192 bits       |               |               |                 |
|                 +----------------+               +               +                 +
|                 | 256 bits       |               |               |                 |
