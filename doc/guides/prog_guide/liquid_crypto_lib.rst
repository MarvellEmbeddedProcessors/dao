...
+----------------+----------------+---------------+
| SHA1-HMAC      | 1 - 64 bytes   | 20 bytes      |
+----------------+----------------+---------------+
| SHA2-224-HMAC  | 1 - 64 bytes   | 28 bytes      |
+----------------+----------------+---------------+
| SHA2-256-HMAC  | 1 - 64 bytes   | 32 bytes      |
+----------------+----------------+---------------+
| SHA2-384-HMAC  | 1 - 128 bytes  | 48 bytes      |
+----------------+----------------+---------------+
| SHA2-512-HMAC  | 1 - 128 bytes  | 64 bytes      |
+----------------+----------------+---------------+
| SHA3-224-HMAC  | 1 - 128 bytes  | 28 bytes      |
+----------------+----------------+---------------+
| SHA3-256-HMAC  | 1 - 128 bytes  | 32 bytes      |
+----------------+----------------+---------------+
| SHA3-384-HMAC  | 1 - 128 bytes  | 48 bytes      |
+----------------+----------------+---------------+
| SHA3-512-HMAC  | 1 - 128 bytes  | 64 bytes      |
+----------------+----------------+---------------+
