...
.. code-block:: console
    ...
    wget "https://github.com/MarvellEmbeddedProcessors/dao/releases/download/oct-ep-target-cn10k-25.10.0-ubuntu-24.04-devel/oct-ep-target-cn10k-devel_25.10.0_arm64.deb"
    sudo apt-get install -y ./"oct-ep-target-cn10k-devel_25.10.0_arm64.deb"
    #Build VPP
