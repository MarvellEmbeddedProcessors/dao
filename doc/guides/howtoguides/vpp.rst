...
.. code-block:: console
    ...
    wget "https://github.com/MarvellEmbeddedProcessors/pcie_ep_octeon_target/releases/download/oct-ep-target-cn10k-25.10.0-ubuntu-24.04-25.10.0/oct-ep-target-cn10k_25.10.0_arm64.deb"
    sudo apt-get install -y ./"oct-ep-target-cn10k_25.10.0_arm64.deb"
    #Build VPP
