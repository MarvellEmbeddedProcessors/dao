...
static void
add_mark(struct rte_flow_action *actions, uint8_t actions_counter, struct additional_para para)
{
...
static void
add_queue(struct rte_flow_action *actions, uint8_t actions_counter, struct additional_para para)
{
...
static void
add_jump(struct rte_flow_action *actions, uint8_t actions_counter, struct additional_para para)
{
...
static void
add_rss(struct rte_flow_action *actions, uint8_t actions_counter, struct additional_para para)
{
	...
	if (rss_data[para.core_idx] == NULL)
		rss_data[para.core_idx] = rte_malloc("rss_data", sizeof(struct action_rss_data), 0);
...
static void
add_set_meta(struct rte_flow_action *actions, uint8_t actions_counter,
...
static void
add_set_tag(struct rte_flow_action *actions, uint8_t actions_counter,
	    __rte_unused struct additional_para para)
{
...
static void
add_port_id(struct rte_flow_action *actions, uint8_t actions_counter, struct additional_para para)
{
...
static void
add_drop(struct rte_flow_action *actions, uint8_t actions_counter,
	 __rte_unused struct additional_para para)
{
...
static void
add_count(struct rte_flow_action *actions, uint8_t actions_counter,
	  __rte_unused struct additional_para para)
{
...
static void
add_set_src_mac(struct rte_flow_action *actions, uint8_t actions_counter,
...
static void
add_set_dst_mac(struct rte_flow_action *actions, uint8_t actions_counter,
		struct additional_para para)
{
	static struct rte_flow_action_set_mac set_macs[RTE_MAX_LCORE] __rte_cache_aligned;
	uint32_t mac = para.counter;
...
static void
add_set_src_ipv4(struct rte_flow_action *actions, uint8_t actions_counter,
		 struct additional_para para)
{
...
static void
add_set_dst_ipv4(struct rte_flow_action *actions, uint8_t actions_counter,
		 struct additional_para para)
{
	static struct rte_flow_action_set_ipv4 set_ipv4[RTE_MAX_LCORE] __rte_cache_aligned;
	uint32_t ip = para.counter;
...
static void
add_set_src_ipv6(struct rte_flow_action *actions, uint8_t actions_counter,
		 struct additional_para para)
{
...
static void
add_set_dst_ipv6(struct rte_flow_action *actions, uint8_t actions_counter,
		 struct additional_para para)
{
	static struct rte_flow_action_set_ipv6 set_ipv6[RTE_MAX_LCORE] __rte_cache_aligned;
	uint32_t ipv6 = para.counter;
...
static void
add_set_src_tp(struct rte_flow_action *actions, uint8_t actions_counter,
	       struct additional_para para)
{
...
static void
add_set_dst_tp(struct rte_flow_action *actions, uint8_t actions_counter,
	       struct additional_para para)
{
	static struct rte_flow_action_set_tp set_tp[RTE_MAX_LCORE] __rte_cache_aligned;
	uint32_t tp = para.counter;
...
static void
add_inc_tcp_ack(struct rte_flow_action *actions, uint8_t actions_counter,
		struct additional_para para)
{
...
static void
add_dec_tcp_ack(struct rte_flow_action *actions, uint8_t actions_counter,
		struct additional_para para)
{
	static rte_be32_t value[RTE_MAX_LCORE] __rte_cache_aligned;
	uint32_t ack_value = para.counter;
...
static void
add_inc_tcp_seq(struct rte_flow_action *actions, uint8_t actions_counter,
		struct additional_para para)
{
	static rte_be32_t value[RTE_MAX_LCORE] __rte_cache_aligned;
...
static void
add_dec_tcp_seq(struct rte_flow_action *actions, uint8_t actions_counter,
		struct additional_para para)
{
	static rte_be32_t value[RTE_MAX_LCORE] __rte_cache_aligned;
	uint32_t seq_value = para.counter;
...
static void
add_set_ttl(struct rte_flow_action *actions, uint8_t actions_counter, struct additional_para para)
{
...
static void
add_dec_ttl(struct rte_flow_action *actions, uint8_t actions_counter,
	    __rte_unused struct additional_para para)
{
...
static void
add_set_ipv4_dscp(struct rte_flow_action *actions, uint8_t actions_counter,
		  struct additional_para para)
{
...
static void
add_set_ipv6_dscp(struct rte_flow_action *actions, uint8_t actions_counter,
		  struct additional_para para)
{
	static struct rte_flow_action_set_dscp set_dscp[RTE_MAX_LCORE] __rte_cache_aligned;
	uint32_t dscp_value = para.counter;
...
static void
add_flag(struct rte_flow_action *actions, uint8_t actions_counter,
	 __rte_unused struct additional_para para)
{
...
static void
add_ether_header(uint8_t **header, uint64_t data, __rte_unused struct additional_para para)
{
...
static void
add_vlan_header(uint8_t **header, uint64_t data, __rte_unused struct additional_para para)
{
...
static void
add_ipv4_header(uint8_t **header, uint64_t data, struct additional_para para)
{
...
static void
add_ipv6_header(uint8_t **header, uint64_t data, __rte_unused struct additional_para para)
{
...
static void
add_udp_header(uint8_t **header, uint64_t data, __rte_unused struct additional_para para)
{
...
static void
add_vxlan_header(uint8_t **header, uint64_t data, struct additional_para para)
{
...
static void
add_vxlan_gpe_header(uint8_t **header, uint64_t data, struct additional_para para)
{
...
static void
add_gre_header(uint8_t **header, uint64_t data, __rte_unused struct additional_para para)
{
...
static void
add_geneve_header(uint8_t **header, uint64_t data, struct additional_para para)
{
...
static void
add_gtp_header(uint8_t **header, uint64_t data, struct additional_para para)
{
...
static const struct encap_decap_headers {
	...
	{.funct = add_ether_header},     {.funct = add_vlan_header}, {.funct = add_ipv4_header},
	{.funct = add_ipv6_header},      {.funct = add_udp_header},  {.funct = add_vxlan_header},
	{.funct = add_vxlan_gpe_header}, {.funct = add_gre_header},  {.funct = add_geneve_header},
	{.funct = add_gtp_header},
};

static void
add_raw_encap(struct rte_flow_action *actions, uint8_t actions_counter, struct additional_para para)
{
...
static void
add_raw_decap(struct rte_flow_action *actions, uint8_t actions_counter, struct additional_para para)
{
...
static void
add_vxlan_encap(struct rte_flow_action *actions, uint8_t actions_counter,
		__rte_unused struct additional_para para)
{
...
static void
add_vxlan_decap(struct rte_flow_action *actions, uint8_t actions_counter,
		__rte_unused struct additional_para para)
{
...
static void
add_meter(struct rte_flow_action *actions, uint8_t actions_counter,
	  __rte_unused struct additional_para para)
{
...
void
fill_actions(struct rte_flow_action *actions, uint64_t *flow_actions, uint32_t counter,
	     uint16_t next_table, uint16_t hairpinq, uint64_t encap_data, uint64_t decap_data,
	     uint8_t core_idx, bool unique_data, uint8_t rx_queues_count, uint16_t dst_port)
{
	...
	static const struct actions_dict {
		...
		{.mask = FLOW_ACTION_MASK(RTE_FLOW_ACTION_TYPE_PORT_ID), .funct = add_port_id},
		{
