...
static struct test_sym_params aes_cbc_128_empty_test_data = {
	.ctx = {
		.opcode = DAO_LC_SYM_OPCODE_FC,
		.fc = {
			.iv_source = DAO_LC_FC_IV_SRC_OP,
...
static struct test_sym_params aes_cbc_192_empty_test_data = {
	.ctx = {
		.opcode = DAO_LC_SYM_OPCODE_FC,
		.fc = {
			.iv_source = DAO_LC_FC_IV_SRC_OP,
...
static struct test_sym_params aes_cbc_256_empty_test_data = {
	.ctx = {
		.opcode = DAO_LC_SYM_OPCODE_FC,
		.fc = {
			.iv_source = DAO_LC_FC_IV_SRC_OP,
...
static const uint8_t digest_aes_cbc_128_sha1_hmac[] = {
	0x9A, 0x4F, 0x88, 0x1B, 0xB6, 0x8F, 0xD8, 0x60,
	0x42, 0x1A, 0x7D, 0x3D, 0xF5, 0x82, 0x80, 0xF1,
	0x18, 0x8C, 0x1D, 0x32
};

static struct test_sym_params aes_cbc_128_sha1_hmac_test_data = {
	.ctx = {
		.opcode = DAO_LC_SYM_OPCODE_FC,
		.chain_order = DAO_LC_FC_CIPHER_THEN_AUTH,
		.fc = {
			.iv_source = DAO_LC_FC_IV_SRC_OP,
			.aes_key_len = DAO_LC_FC_AES_KEY_LEN_128,
			.mac_len = 20,
			...
			.auth_input_type = DAO_LC_FC_AUTH_INPUT_KEY,
			.opad = { /** Auth Key. Length: must be zero-padded till 64 bytes */
	...
	.digest_data = digest_aes_cbc_128_sha1_hmac
};

static const uint8_t digest_aes_cbc_128_sha1_hmac_empty[] = {
	0x1e, 0x28, 0xb1, 0x64, 0x24, 0x8a, 0x04, 0x4e,
	0x48, 0x0e, 0xd5, 0x17, 0x79, 0xd0, 0x36, 0x38,
	0x16, 0xbe, 0xe8, 0xcd
};

static struct test_sym_params aes_cbc_128_sha1_hmac_empty_test_data = {
	.ctx = {
		.opcode = DAO_LC_SYM_OPCODE_FC,
		.chain_order = DAO_LC_FC_CIPHER_THEN_AUTH,
		.fc = {
	...
	.digest_data = digest_aes_cbc_128_sha1_hmac_empty
};

/** AES-128-CBC SHA1-HMAC with different cipher and auth offset test vectors */
static const uint8_t plaintext_aes_cbc_128_sha1_hmac_offsets[] = {
...
static const uint8_t ciphertext_aes_cbc_128_sha1_hmac_offsets_1[] = {
...
static const uint8_t digest_aes_cbc_128_sha1_hmac_offsets_1[] = {
	0xd9, 0xe1, 0x01, 0xd7, 0xd6, 0x4c, 0x2f, 0xeb,
	0x77, 0x54, 0xd6, 0xa1, 0xf9, 0x45, 0xb7, 0xe7,
	0xae, 0x7a, 0x35, 0xf6
};

static struct test_sym_params aes_cbc_128_sha1_hmac_offsets_test_data_1 = {
	.ctx = {
		.opcode = DAO_LC_SYM_OPCODE_FC,
		.chain_order = DAO_LC_FC_CIPHER_THEN_AUTH,
		.fc = {
	...
	.plaintext = {
		.data = plaintext_aes_cbc_128_sha1_hmac_offsets,
		.len = 64
	},
	.ciphertext = {
		.data = ciphertext_aes_cbc_128_sha1_hmac_offsets_1,
		.len = 48
	},
	.digest_data = digest_aes_cbc_128_sha1_hmac_offsets_1,
	.cipher_offset = 16,
	.auth_offset = 8,
	.cipher_len = 48,
	.auth_len = 56
