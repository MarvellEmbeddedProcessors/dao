...
struct unit_test_suite lc_testsuite_sym = {
	...
	.unit_test_cases = {
		...
		TEST_CASE_NAMED_WITH_DATA("AES-128-CBC Decrypt OOP", ut_setup, ut_teardown,
					  ...
					  &aes_cbc_128_test_data),
		TEST_CASE_NAMED_WITH_DATA("AES-128-CBC Zero Length Encrypt", ut_setup,
					  ut_teardown, test_block_cipher_only_encrypt,
					  &aes_cbc_128_empty_test_data),
		TEST_CASE_NAMED_WITH_DATA("AES-128-CBC Zero Length Decrypt", ut_setup,
					  ut_teardown, test_block_cipher_only_decrypt,
					  &aes_cbc_128_empty_test_data),
		TEST_CASE_NAMED_WITH_DATA("AES-128-CBC Zero Length Encrypt OOP", ut_setup,
					  ut_teardown, test_block_cipher_only_encrypt_oop,
					  &aes_cbc_128_empty_test_data),
		TEST_CASE_NAMED_WITH_DATA("AES-128-CBC Zero Length Decrypt OOP", ut_setup,
		...
		TEST_CASE_NAMED_WITH_DATA("AES-192-CBC Decrypt OOP", ut_setup, ut_teardown,
					  test_block_cipher_only_decrypt_oop,
					  &aes_cbc_192_test_data),
		TEST_CASE_NAMED_WITH_DATA("AES-192-CBC Zero Length Encrypt", ut_setup,
					  ut_teardown, test_block_cipher_only_encrypt,
					  &aes_cbc_192_empty_test_data),
		TEST_CASE_NAMED_WITH_DATA("AES-192-CBC Zero Length Decrypt", ut_setup,
					  ut_teardown, test_block_cipher_only_decrypt,
					  &aes_cbc_192_empty_test_data),
		TEST_CASE_NAMED_WITH_DATA("AES-192-CBC Zero Length Encrypt OOP", ut_setup,
					  ut_teardown, test_block_cipher_only_encrypt_oop,
					  &aes_cbc_192_empty_test_data),
		TEST_CASE_NAMED_WITH_DATA("AES-192-CBC Zero Length Decrypt OOP", ut_setup,
					  ut_teardown, test_block_cipher_only_decrypt_oop,
					  &aes_cbc_192_empty_test_data),
		...
		TEST_CASE_NAMED_WITH_DATA("AES-256-CBC Decrypt OOP", ut_setup, ut_teardown,
					  test_block_cipher_only_decrypt_oop,
					  &aes_cbc_256_test_data),
		TEST_CASE_NAMED_WITH_DATA("AES-256-CBC Zero Length Encrypt", ut_setup,
					  ut_teardown, test_block_cipher_only_encrypt,
					  &aes_cbc_256_empty_test_data),
		TEST_CASE_NAMED_WITH_DATA("AES-256-CBC Zero Length Decrypt", ut_setup,
					  ut_teardown, test_block_cipher_only_decrypt,
					  &aes_cbc_256_empty_test_data),
		TEST_CASE_NAMED_WITH_DATA("AES-256-CBC Zero Length Encrypt OOP", ut_setup,
					  ut_teardown, test_block_cipher_only_encrypt_oop,
					  &aes_cbc_256_empty_test_data),
		TEST_CASE_NAMED_WITH_DATA("AES-256-CBC Zero Length Decrypt OOP", ut_setup,
					  ut_teardown, test_block_cipher_only_decrypt_oop,
					  &aes_cbc_256_empty_test_data),
