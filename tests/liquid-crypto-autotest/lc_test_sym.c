...
struct unit_test_suite lc_testsuite_sym = {
	...
	.unit_test_cases = {
		...
		TEST_CASE_NAMED_WITH_DATA("AES-12B-CMAC Digest Gen", ut_setup, ut_teardown,
					  test_hash_gen, &aes_cmac_12B_test_data),
		TEST_CASE_NAMED_WITH_DATA("AES-12B-CMAC Digest Verify", ut_setup, ut_teardown,
					  test_hash_verify, &aes_cmac_12B_test_data),
		TEST_CASE_NAMED_WITH_DATA("AES-16B-CMAC Digest Gen", ut_setup, ut_teardown,
					  test_hash_gen, &aes_cmac_16B_test_data),
		TEST_CASE_NAMED_WITH_DATA("AES-16B-CMAC Digest Verify", ut_setup, ut_teardown,
					  test_hash_verify, &aes_cmac_16B_test_data),
		...
		TEST_CASE_NAMED_WITH_DATA("SHA1 Digest Gen with 1024 byte key data", ut_setup,
					  ut_teardown, test_hash_gen,
					  &hmac_sha1_with_1024_byte_key_test_data),
		TEST_CASE_NAMED_WITH_DATA("SHA1 Digest Verify with 1024 byte key data", ut_setup,
					  ut_teardown, test_hash_verify,
					  &hmac_sha1_with_1024_byte_key_test_data),
		...
		TEST_CASE_NAMED_WITH_DATA("SHA256 Digest Gen with 1024 byte key data", ut_setup,
					  ut_teardown, test_hash_gen,
					  &hmac_sha256_with_1024_byte_key_test_data),
		TEST_CASE_NAMED_WITH_DATA("SHA256 Digest Verify with 1024 byte key data", ut_setup,
					  ut_teardown, test_hash_verify,
					  &hmac_sha256_with_1024_byte_key_test_data),
		...
		TEST_CASE_NAMED_WITH_DATA("HMAC-SHA3-224 Digest Gen with 28 byte key data",
					  ...
					  &hmac_sha3_224_with_28_byte_key_test_data),
		...
		TEST_CASE_NAMED_WITH_DATA("HMAC-SHA3-256 Digest Gen with 32 byte key data",
					  ut_setup, ut_teardown, test_hash_gen,
					  &hmac_sha3_256_with_32_byte_key_test_data),
		...
		TEST_CASE_NAMED_WITH_DATA("HMAC-SHA3-384 Digest Gen with 48 byte key data",
					  ut_setup, ut_teardown, test_hash_gen,
					  &hmac_sha3_384_with_48_byte_key_test_data),
		...
		TEST_CASE_NAMED_WITH_DATA("HMAC-SHA3-512 Digest Gen with 64 byte key data",
					  ut_setup, ut_teardown, test_hash_gen,
					  &hmac_sha3_512_with_64_byte_key_test_data),
		...
		TEST_CASE_NAMED_WITH_DATA("HMAC_SHA3-224 Digest Gen with 128 byte key data",
					  ut_setup, ut_teardown, test_hash_gen,
					  &hmac_sha3_224_with_128_byte_key_test_data),
		...
		TEST_CASE_NAMED_WITH_DATA("HMAC_SHA3-256 Digest Gen with 128 byte key data",
					  ut_setup, ut_teardown, test_hash_gen,
					  &hmac_sha3_256_with_128_byte_key_test_data),
		...
		TEST_CASE_NAMED_WITH_DATA("HMAC_SHA3-384 Digest Gen with 128 byte key data",
					  ut_setup, ut_teardown, test_hash_gen,
					  &hmac_sha3_384_with_128_byte_key_test_data),
		...
		TEST_CASE_NAMED_WITH_DATA("HMAC_SHA3-512 Digest Gen with 128 byte key data",
					  ut_setup, ut_teardown, test_hash_gen,
					  &hmac_sha3_512_with_128_byte_key_test_data),
		...
		TEST_CASE_NAMED_WITH_DATA("HMAC_SHA3-224 Digest Gen with 358 byte key data",
					  ut_setup, ut_teardown, test_hash_gen,
					  &hmac_sha3_224_with_358_byte_key_test_data),
		...
		TEST_CASE_NAMED_WITH_DATA("HMAC_SHA3-224 Digest Gen with 360 byte key data",
					  ut_setup, ut_teardown, test_hash_gen,
					  &hmac_sha3_224_with_360_byte_key_test_data),
		...
		TEST_CASE_NAMED_WITH_DATA("HMAC_SHA3-224 Digest Gen with 1024 byte key data",
					  ut_setup, ut_teardown, test_hash_gen,
					  &hmac_sha3_224_with_1024_byte_key_test_data),
